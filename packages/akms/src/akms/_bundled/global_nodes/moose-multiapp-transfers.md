---
id: moose-multiapp-transfers
title: MOOSE MultiApp and Transfers — Multi-Physics Coupling
domain: architecture
...
- to: moose-mesh-adaptivity
  type: requires
  weight: 0.5
  note: Transfers operate on mesh fields
- to: tgs-dom-fem
  type: implements
  weight: 0.5
  note: MultiApp couples separate FEM solves via field transfers
---

# MOOSE MultiApp and Transfers — Multi-Physics Coupling

Framework knowledge node covering 1 aspect(s) of MultiApp and Transfers — Multi-Physics Coupling.

## MultiApp system for multi-physics coupling
