---
id: moose-pf-multi-phase
title: MOOSE Multi-phase field models in MOOSE
domain: phase-field
...
- to: moose-multi-phase-component
  type: refines
  weight: 0.9
  note: Fine-grained aspect of moose-multi-phase-component
---

# MOOSE Multi-phase field models in MOOSE
