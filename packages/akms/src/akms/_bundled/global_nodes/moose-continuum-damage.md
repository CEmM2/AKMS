---
id: moose-continuum-damage
title: MOOSE Damage and Fracture Mechanics (Non-Phase-Field)
domain: constitutive
...
- to: moose-return-mapping-base
  type: requires
  weight: 0.6
  note: Damage models can use return mapping framework
- to: cm-gtn-ductile-fracture
  type: implements
  weight: 0.7
  note: Implements continuum damage mechanics framework
---

# MOOSE Damage and Fracture Mechanics (Non-Phase-Field)

Framework knowledge node covering 1 aspect(s) of Damage and Fracture Mechanics (Non-Phase-Field).

## Continuum damage mechanics in MOOSE
